...
utAtom: mainAtom.o list.o atom.o struct.o
	g++ -o utAtom mainAtom.o atom.o list.o struct.o  -lgtest -pthread
...
utVariable: mainVariable.o atom.o struct.o
		g++ -o utVariable mainVariable.o atom.o struct.o -lgtest -pthread
mainVariable.o: mainVariable.cpp utVariable.h variable.h
		g++ --std=gnu++0x -c mainVariable.cpp
list.o:list.cpp list.h
		g++ --std=gnu++0x -c list.cpp -lgtest -pthread
...
utScanner: mainScanner.o atom.o list.o struct.o scanner.h utScanner.h utParser.h parser.h
	g++ -o utScanner mainScanner.o atom.o list.o struct.o -lgtest -pthread
...
utIterator: mainIterator.o atom.o list.o struct.o iterator.h utIterator.h
	g++ -o utIterator mainIterator.o atom.o list.o struct.o -lgtest -pthread
